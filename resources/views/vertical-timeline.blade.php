<section class="vertical-timeline">
    <div class="container">
      <div class="vertical-timeline-item">
        <div class="vertical-timeline-img"></div>

        <div class="vertical-timeline-content js--fadeInLeft">
          <h2>Title</h2>
      ...
      <div class="vertical-timeline-item">
        ...
        <div class="vertical-timeline-content vertical-timeline-card js--fadeInRight">
          <div class="vertical-timeline-img-header">
            <h2>Card Title</h2>
          </div>
      ...
      <div class="vertical-timeline-item">
        ...
        <div class="vertical-timeline-content js--fadeInRight">
          <h2>Title</h2>
      ...
      <div class="vertical-timeline-item">
        ...
        <div class="vertical-timeline-content vertical-timeline-card js--fadeInLeft">
          <div class="vertical-timeline-img-header">
            <h2>Card Title</h2>
          </div>
